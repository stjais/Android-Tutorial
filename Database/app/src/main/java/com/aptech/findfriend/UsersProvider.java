...
public class UsersProvider extends ContentProvider {
    ...
    public static final String PROVIDER_NAME = "com.aptech.findfriend.UsersProvider";
    ...
    public int delete(@NonNull Uri uri,
        ...
        switch (uriMatcher.match(uri)) {
            case USERS:
                count = db.delete(USERS_TABLE_NAME, selection,
                        selectionArgs);
                break;

            case USER_ID:
                String id = uri.getPathSegments().get(1);
                count = db.delete(USERS_TABLE_NAME, MOBILE_NUMBER +
                        " = " + id +
    ...
    public int update(@NonNull Uri uri,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case USER_ID:
                count = db.update(USERS_TABLE_NAME, contentValues,
                        MOBILE_NUMBER + " = " + uri.getPathSegments().get(1) + (!TextUtils.isEmpty(selection) ? " AND(" + selection + ')' : ""), selectionArgs);
                break;
            default:
